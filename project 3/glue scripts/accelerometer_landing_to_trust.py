...
'''
SQLQuery_node1770768657821 = sparkSqlQuery(glueContext, query = SqlQuery665, mapping = {"myDataSource":CustomerPrivacyFilter_node1770768565388}, transformation_ctx = "SQLQuery_node1770768657821")
...
accelerometer_trusted_node1770768898534 = glueContext.getSink(path="s3://stedi-lake-house-han/trusted/accelerometer/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], compression="gzip", enableUpdateCatalog=True, transformation_ctx="accelerometer_trusted_node1770768898534")
