...
'''
SQLQuery_node1770767954102 = sparkSqlQuery(glueContext, query = SqlQuery994, mapping = {"myDataSource":customerLanding_node1770764886846}, transformation_ctx = "SQLQuery_node1770767954102")
...
customer_trusted_node1770768202795 = glueContext.getSink(path="s3://stedi-lake-house-han/trusted/customer/", connection_type="s3", updateBehavior="UPDATE_IN_DATABASE", partitionKeys=[], compression="gzip", enableUpdateCatalog=True, transformation_ctx="customer_trusted_node1770768202795")
